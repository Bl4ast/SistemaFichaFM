// =============================================================
// GRIMÓRIO API — Vercel Serverless Function
// Deploy em: /api/grimorio.js
// Toda lógica, dados e banco de símbolos ficam protegidos aqui.
// =============================================================
...
const bdGrimorio = {
  essencias: [
    ...
    { id: 'e_odor',   sub: 'Corpo e Biologia',     nome: 'Odor/Cheiro',          desc: 'Atrai monstros, esconde cheiro, enoja.',                    cor: '#bdb76b' },
  ...
  gatilhos: [
    ...
    { id: 'g_hommor', sub: 'Combate e Reações Táticas',               nome: 'Homem-Morto',          desc: 'Só ativa se você cair inconsciente.' },
    { id: 'g_desarm', sub: 'Combate e Reações Táticas',               nome: 'Desarme',              desc: 'Item dá choque se arrancado da sua mão.' },
    ...
    { id: 'g_tmpdia', sub: 'Tempo e Regras Especiais',                nome: 'Temporizador Diário',  desc: 'Ativa sozinho todo dia ao meio-dia.' },
    { id: 'g_ecomag', sub: 'Tempo e Regras Especiais',                nome: 'Eco Mágico',           desc: 'Desperta se alguém conjurar magia perto de você.' },
    { id: 'g_absfei', sub: 'Tempo e Regras Especiais',                nome: 'Absorção de Feitiço',  desc: 'Engole magia recebida e ativa seu próprio efeito.' },
...
const ditCondicoes = {
  "Abalado":       "-2 em testes.",
  "Agarrado":      "-2 em ataques/Reflexos. Deslocamento 0.",
  "Alucinado":     "-2 em testes. 50% perder ação.",
  "Apavorado":     "-5 em testes. Deve fugir.",
  "Asfixiado":     "Após CON turnos, 0 PV.",
  "Atordoado":     "Não age, Defesa -5. Falha Reflexos.",
  "Cego":          "Desprevenido, deslocamento metade.",
  "Confuso":       "Comportamento aleatório.",
  "Debilitado":    "-5 FOR/DES/CON.",
  "Desprevenido":  "-5 Defesa, sem reações.",
  "Doente":        "-2 em atributos/perícias.",
  "Enjoado":       "Só padrão ou movimento.",
  "Enredado":      "-2 ataques/Reflexos, metade desloc.",
  "Envenenado":    "Sofre veneno.",
  "Escondido":     "+5 Furtividade, inimigos desprevenidos.",
  "Esmagado":      "Indefeso, dano.",
  "Exausto":       "-5 FOR/DES/CON, metade desloc.",
  "Fadigado":      "Não corre/investe.",
  "Fascinado":     "-5 Percepção.",
  "Fraco":         "-2 FOR/DES/CON.",
  "Frustrado":     "-2 INT/SAB/PRE.",
  "Hemorragia":    "1d6 PV por turno.",
  "Inconsciente":  "Indefeso, cai.",
  "Indefeso":      "-10 Defesa, crítico auto.",
  "Lento":         "Metade desloc.",
  "Morrendo":      "Testes CON.",
  "Ofuscado":      "-2 ataques/visão.",
  "Paralisado":    "Indefeso.",
  "Pasmo":         "Não age.",
  "Petrificado":   "Inconsciente (pedra).",
  "Preso":         "Indefeso/Agarrado.",
  "Prostrado":     "-5 C-a-C.",
  "Queimando":     "Fogo contínuo.",
  "Surdo":         "-5 Iniciativa, falha 20% magia.",
  "Vulnerável":    "-2 Defesa.",
};
...
const periciasBase = [
  ...
  { id: 'feiticaria',   nome: 'Feitiçaria',   attr: 'int' },
  { id: 'fortitude',    nome: 'Fortitude',    attr: 'con' },
  { id: 'furtividade',  nome: 'Furtividade',  attr: 'des' },
  { id: 'iniciativa',   nome: 'Iniciativa',   attr: 'des' },
